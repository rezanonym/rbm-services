...
class User extends CI_Controller
{
    ...
    public function reservasi()
    {
        ...
        // config
        $config['base_url'] = 'http://localhost/RBM-Service/user/reservasi';
    ...
    public function slot_bengkel()
    {
        ...
        // config
        $config['base_url'] = 'http://localhost/RBM-Service/staff/slot_bengkel';
        $config['total_rows'] = $this->users->countAllSlot();
        $config['per_page'] = 5;
        $config['num_links'] = 3;
    ...
    public function history()
    {
        ...
        // config
        $config['base_url'] = 'http://localhost/RBM-Service/user/history';
