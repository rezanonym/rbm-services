                    ...
                    <?php foreach ($getSlotBengkel as $sb) : ?>
                        <tr>
                            ...
                            <?php elseif ($sb['is_ready'] == 3) : ?>
                                <td style="display: flex; justify-content: center; align-items: center; height: 100%;">
                                    <span class="badge text-center text-light" style="background-color: #0E21A0;">Selesai</span>
                                </td>
                            <?php else : ?>
                                <td style="display: flex; justify-content: center; align-items: center; height: 100%;">
                            ...
                            <td>
                                <center>
                                    ...
                                    <?php endif; ?>
                                    <a href="" class="badge text-light" style="background-color: #0E21A0;" data-toggle="modal" data-target="#editSubMenuModal<?= $sb['id']; ?>">Edit</a>
