                ...
                <tbody>
                    ...
                    <?php foreach ($getSlotBengkel as $sb) : ?>
                        <tr>
                            ...
                            <?php else : ?>
                                <td>
                                    <span class="badge badge-warning text-dark ml-5">Jadwal sudah di booking</span>
                                </td>
                            <?php endif; ?>
                            <td>
                                <center>
                            ...
                            <td>
                                <center>
                                    <a href="" class="badge badge-success" data-toggle="modal" data-target="#newSlotModal<?= $sb['id']; ?>">Pesan</a>
                                </center>
                            </td>
                        </tr>
                        <?php $i++ ?>
